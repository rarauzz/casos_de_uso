'use strict';
const input_util = document.querySelector('#txt_util_centro');
const input_numero = document.querySelector('#txt_numero_utiles_centro');
const input_descripcion = document.querySelector('#txt_descripcion_utiles_centro');
...
let obtener_datos = () => {
    ...
    if (validar() == false) {
        ...
        registrar_utiles_centro(util, numero, descripcion);
